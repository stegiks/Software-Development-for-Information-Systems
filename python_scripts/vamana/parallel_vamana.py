...
data_unoptimized = pd.read_csv('../../logs/serial/mean_serial.txt', sep='\t', header=None, nrows=36)
data_optimized = pd.read_csv('../../logs/parallel/mean_parallel.txt', sep='\t', header=None, nrows=36)
...
plt.tight_layout()
plt.savefig('parallel_vamana.png')